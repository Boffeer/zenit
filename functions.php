...
function zenit_scripts() {
	wp_enqueue_style( 'zenit-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'zenit-style', 'rtl', 'replace' );

	wp_enqueue_script( 'zenit-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

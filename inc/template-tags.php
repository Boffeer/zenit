...
?>
	...
	<div class="detail-news-page__footer-social fl-align likely">
		<p class="detail-news-page__footer-social-text">Поделиться:</p>
		<div class="facebook">
			<div class="detail-news-page__footer-social-link">
		...
		<?php /*
		<!-- У инстаграма в принципе нет возможности расшарить ссылку с внешнего источника, поэтому отключил -->
		<!-- https://ru.stackoverflow.com/questions/1098940/Можно-ли-сделать-на-сайте-кнопку-Поделиться-в-инстаграмм -->
		<div class="instagram">
			<div class="detail-news-page__footer-social-link">

		...
		<div class="content-page__container">
			<div class="catalog-detail">
				<div class="catalog-detail__header">
					...
					<?php if (!get_post_thumbnail_id($post->ID) == 0 && !empty($thumb)) : ?>
				...
				<?php function show_stats($stats)
				{
					return ($stats[0][0]) != '' && count($stats) > 0;
				} ?>
				<?php $files = carbon_get_post_meta(get_the_id(), 'files'); ?>

				<?php if (show_stats($stats) || get_the_content() != null || !empty($files)) : ?>
